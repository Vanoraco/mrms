...
// Campus URLs
export const GET_CAMPUSES = "/v1/campuses";
export const POST_CAMPUS = "/v1/campuses";
export const PUT_CAMPUS = "/v1/campuses";
export const DELETE_CAMPUS = "/v1/campuses";

// BLOCK
export const GET_BLOCKS = "/v1/blocks";
export const GET_BLOCK = "/v1/blocks/";
export const POST_BLOCK = "/v1/blocks";
export const PUT_BLOCK = "/v1/blocks";
export const DELETE_BLOCK = "/v1/blocks";

// BUILDING
export const GET_BUILDINGS = "/v1/buildings";
export const GET_BUILDING = "/v1/buildings/";
export const POST_BUILDING = "/v1/buildings";
export const PUT_BUILDING = "/v1/buildings";
export const DELETE_BUILDING = "/v1/buildings";

// Room
export const GET_ROOMS = "/v1/rooms";
export const GET_ROOM = "/v1/rooms/";
export const POST_ROOM = "/v1/rooms";
export const PUT_ROOM = "/v1/rooms";
export const DELETE_ROOM = "/v1/rooms";

// Room Type
export const GET_ROOM_TYPES = "/v1/room-types";
export const GET_ROOM_TYPE = "/v1/room-types/";
export const POST_ROOM_TYPE = "/v1/room-types";
export const PUT_ROOM_TYPE = "/v1/room-types";
export const DELETE_ROOM_TYPE = "/v1/room-types";

// Room Facility
export const GET_ROOM_FACILITIES = "/v1/room-facilities";
export const GET_ROOM_FACILITY = "/v1/room-facilities/";
export const POST_ROOM_FACILITY = "/v1/room-facilities";
export const PUT_ROOM_FACILITY = "/v1/room-facilities";
export const DELETE_ROOM_FACILITY = "/v1/room-facilities";

// Department Type
export const GET_DEPARTMENT_TYPES = "/v1/department-types";
export const GET_DEPARTMENT_TYPE = "/v1/department-types/";
